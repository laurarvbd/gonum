...
func EqualWithinRel(a, b complex128, tol float64) bool {
	...
	return floats.EqualWithinRel(real(a), real(b), tol) && floats.EqualWithinRel(imag(a), imag(b), tol)
}
...
func EqualWithinULP(a, b complex128, ulp uint) bool {
	...
	return floats.EqualWithinULP(real(a), real(b), ulp) && floats.EqualWithinULP(imag(a), imag(b), ulp)
}
